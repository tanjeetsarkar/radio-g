...
class NewsKafkaConsumer:
    ...
    def consume_continuous(
        self,
        callback: Callable[[NewsItem], None],
...
def print_news_item(news_item: NewsItem):
    ...
    print(f"Content: {news_item.content[:200] if news_item.content else news_item.content}...")
    print("="*80)
